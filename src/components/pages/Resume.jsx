  ...
  return (
    <>
      <section id="resume" class="resume">
        <div class="container">
          <div class="section-title title-box text-center">
            <h3 class="title-a">Resume</h3>
          ...
          <div class="row">
            <div class="col-lg-6" data-aos="fade-up">
              ...
              <div class="resume-item">
                ...
                <h5>2015 - 2019</h5>
                <p>
                  <em>B.P. Poddar Institure of Management & Technology</em>
                </p>
                <p>
              ...
              <div class="resume-item">
                ...
                <h5>2013 - 2014</h5>
                <p>
                  <em>Hooghly Branch Govt. High School</em>
                </p>
                <p>
